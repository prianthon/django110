...
class QuestionMethodTests(TestCase):
    ...
    def create_question(question_text, days):
        """
        Creates a question with the given 'question_text' and published the given number of 'days' offset to now (negative for questions published in the past, pisitive for questions that have yet to be published).
        """
